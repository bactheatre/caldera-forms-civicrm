...
class Add_Caldera_Form_Event_Date_Ajax extends QSOT_Base_Event_Area_Type {
	...
	public static function instance() {
		...
		if ( isset( self::$instance ) && self::$instance instanceof Add_Caldera_Form_Event_Date_Ajax )
			return self::$instance;

		// otherwise, start a new instance
		return self::$instance = new Add_Caldera_Form_Event_Date_Ajax();
	}
	...
	public function admin_ajax_load_event( $data, $event, $event_area, $order ) {
		...
		$frmt = QSOT_Date_Formats::php_date_format( 'D, F jS, Y h:ia' );
